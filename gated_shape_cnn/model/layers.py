...
class MobPreactUnit(tf.keras.layers.Layer):
    """
    input                   [b, h, w, c]
    x = batch_norm(x)       [b, h, w, c]
    x = relu(x)             [b, h, w, c]
    ...
    """
    def __init__(self, **kwargs):
        super(MobPreactUnit, self).__init__(**kwargs)
...
class ShapeAttention(tf.keras.layers.Layer):
    ...
    def __init__(self, **kwargs):
        ...
        self.mob_1 = MobPreactUnit()
        self.mob_2 = MobPreactUnit()
        self.mob_3 = MobPreactUnit()
...
#             })
    ...
    def call(self, inputs, training=None):
        inputs = kapp.mobilenet_v2.preprocess_input(inputs)
